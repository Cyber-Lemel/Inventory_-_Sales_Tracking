<?php
    require "user.php"; // gives us getProductsByCategory(), getPendingProducts(), and $conn
    $products = getProductsByCategory($conn);
    $pendingProducts = getPendingProducts($conn);
    
// ito na admin natin since wala naman na yung staff
// hindi na ko nag change ng name nang file, madami aayusin sa code pag ginawa ko pag nag tanong si sir bakit ano tong user_dashboard, sir name lng po yan, sa admin na po talaga ito.
